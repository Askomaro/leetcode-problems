...
#
# ​
#  −1 since we use 32 bits to represent the number, half of the range is used for negative numbers and 0 is part
#  of the positive numbers
# Knowing the limitation of n, we can now deduce that the maximum value of n that is also a power
# of three is 1162261467. We calculate this as:
#
...
class Solution(object):
    def isPowerOfThree(self, n): return n > 0 and 1162261467 % n == 0
